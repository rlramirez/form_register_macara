...
class DB_mysql {
	...
	function DB_mysql($dbname, $dbhost, $dbuname, $dbpass) {
		$this->BaseDatos = $dbname;
	...
	function verconsulta() {
		//echo "<table border=0>\n";
		echo "<table width=95% align='center' class='table table-hover'>";
		echo "<tr rowspan='2'>";
		// mostramos los nombres de los campos
		for ($i = 0; $i < $this->numcampos(); $i++){
			echo "<td bgColor='#666666'><div align='center' class='titulos_parrafo'><b>".$this->nombrecampo($i)."</b></td>\n";
		}
		echo "</tr>";
